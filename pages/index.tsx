...
import { FlexColCenterStart, FlexRowCenterBetween, FlexRowCenterCenter } from '../Components/Reusables/FlexComponents/FlexConfigs'
...
const Home: NextPage = () => {
  return (
    <Flex width="100vw" height="100%" {...FlexColCenterStart}  paddingTop="68px" paddingBottom="100px" >
      ...
      <Flex {...FlexRowCenterCenter} marginTop="20px" marginBottom={"20px"} width="80%" >
      ...
      <Flex {...FlexColCenterStart} marginTop="30px" >
        ...
        <chakra.h1 fontSize={["72px"]} textAlign="center"  width="100%" fontWeight={"600"} fontFamily={`"BasierCircleSemiBold", sans-serif`} >

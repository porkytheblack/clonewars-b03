...
function HeroBlock() {
  ...
  return (
    <Flex ref={containerRef} width="100vw" overflowX={"hidden"} height="100vh" {...FlexColCenterStart} position="relative" >
        <CustomImage scale={imageScale} src="/assets/revolut/hero_image_desktop.png" width={1356}  height={615}  />
        <Flex width="100%" height="100%" {...FlexColCenterCenter} position="absolute" background="transparent" top="0px" left="0px" >
            <chakra.h1 fontSize={["96px"]} textAlign="center"  width="70%" fontWeight={"600"} fontFamily={`"BasierCircleSemiBold", sans-serif`} >
                Do business globally, from day one
            </chakra.h1>
            <chakra.p width="60%" fontFamily={`"BasierCircleBold", sans-serif`} fontSize="20px" textAlign={"center"} fontWeight="400" >
